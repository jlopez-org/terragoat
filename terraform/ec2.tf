...
@cortex-appsec-us cortex-appsec-us bot on May 21
MEDIUM  [IaC] Ensure that an S3 bucket has a lifecycle configuration
    Asset: /terraform/ec2.tf:aws_s3_bucket.flowbucket | Rule ID: APPSEC2_AWS_61
@Juliandreslopez	Reply...
